...
python prepare_ensemble_cat.py ../dataset/cat_ensemble ../trans_data/cat.label pred_xgboost_cat.txt xgboost 10 pred_linear_cat.txt liblinear
python prepare_ensemble_dog.py ../dataset/dog_ensemble ../trans_data/valid2.label pred_xgboost_dog.txt xgboost 10 pred_linear_dog.txt liblinear
python prepare_ensemble_pig.py ../dataset/pig_ensemble ../raw_data/test.txt pred_xgboost_pig.txt xgboost 10 pred_linear_pig.txt liblinear
