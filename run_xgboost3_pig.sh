...
$BIN xgboost3.conf num_round=200 num_class=18 bst:max_depth=7 data=../dataset/pig_train eval[test]=../dataset/pig_train
$BIN xgboost3.conf task=pred num_class=18 model_in=0200.model test:data=../dataset/pig_test
